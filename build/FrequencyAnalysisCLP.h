...
//  /old_Users/jkitzmann/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /Users/jkitzmann/FrequencyAnalysis/FrequencyAnalysis.xml --OutputCxx /Users/jkitzmann/FrequencyAnalysis/build/FrequencyAnalysisCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"<executable>\n"
"    <category>APPIL</category>\n"
"    <title>FrequencyAnalysis</title>\n"
"    <description>\n"
"        Frequency analysis of image\n"
"    </description>\n"
"    <version>0.2</version>\n"
...
"            <description>Input volume to be analyzed</description>\n"
"        </image>\n"
"        <image>\n"
"            <longflag>outputDirectory</longflag>\n"
"            <label>Output Volume</label>\n"
"            <channel>output</channel>\n"
"            <description>directory for output frequency, mask images</description>\n"
"        </image>\n"
"        <string>\n"
"            <longflag>inputCSVName</longflag>\n"
"            <label>path for input MTF csv</label>\n"
"        </string>\n"
"    </parameters>\n"
"\n"
"    <parameters>\n"
"        <label>Coordinates</label>\n"
"        <description>RAS coordinates of axial in-plane airway recist diameter and slice</description>\n"
"        <float>\n"
"            <longflag>aR</longflag>\n"
"            <label>Right coordinate of first recist point</label>\n"
"        </float>\n"
"        <float>\n"
"            <longflag>aA</longflag>\n"
"            <label>Anterior coordinate of first recist point</label>\n"
"        </float>\n"
"        <float>\n"
"            <longflag>bR</longflag>\n"
"            <label>Right coordinate of second recist point</label>\n"
"        </float>\n"
"        <float>\n"
"            <longflag>bA</longflag>\n"
"            <label>Anterior coordinate of second recist point</label>\n"
"        </float>\n"
"        <integer>\n"
"            <longflag>slice</longflag>\n"
"            <label>Axial slice coordinate of airway recist diameter points.</label>\n"
"        </integer>\n"
"    </parameters>\n"
"\n"
"    <parameters>\n"
"        <label>ROI Calculation</label>\n"
"        <description>Variables for ROI calculation</description>\n"
"        <float>\n"
"            <longflag>roiMult</longflag>\n"
"            <label>RECIST distance multiplier for ROI calculation</label>\n"
"        </float>\n"
"    </parameters>\n"
"\n"
"    <parameters>\n"
"        <label>Modulation</label>\n"
"        <description>Modulations desired for analysis band</description>\n"
"        <float>\n"
"            <longflag>modLow</longflag>\n"
"            <label>low modulation</label>\n"
"        </float>\n"
"        <float>\n"
"            <longflag>modHigh</longflag>\n"
"            <label>high modulation</label>\n"
"        </float>\n"
"\n"
"    </parameters>\n"
"\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.emplace_back("--inputImageName"); \
    nonbooleanFlags.emplace_back("--outputDirectory"); \
    nonbooleanFlags.emplace_back("--inputCSVName"); \
    nonbooleanFlags.emplace_back("--aR"); \
    nonbooleanFlags.emplace_back("--aA"); \
    nonbooleanFlags.emplace_back("--bR"); \
    nonbooleanFlags.emplace_back("--bA"); \
    nonbooleanFlags.emplace_back("--slice"); \
    nonbooleanFlags.emplace_back("--roiMult"); \
    nonbooleanFlags.emplace_back("--modLow"); \
    nonbooleanFlags.emplace_back("--modHigh"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    msg.str("");msg << "Input volume to be analyzed";    TCLAP::ValueArg<std::string > inputImageNameArg("", "inputImageName", msg.str(), false, inputImageName, "std::string", commandLine); \
 \
    msg.str("");msg << "directory for output frequency, mask images";    TCLAP::ValueArg<std::string > outputDirectoryArg("", "outputDirectory", msg.str(), false, outputDirectory, "std::string", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<std::string > inputCSVNameArg("", "inputCSVName", msg.str(), false, inputCSVName, "std::string", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > aRArg("", "aR", msg.str(), false, aR, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > aAArg("", "aA", msg.str(), false, aA, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > bRArg("", "bR", msg.str(), false, bR, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > bAArg("", "bA", msg.str(), false, bA, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<int > sliceArg("", "slice", msg.str(), false, slice, "int", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > roiMultArg("", "roiMult", msg.str(), false, roiMult, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > modLowArg("", "modLow", msg.str(), false, modLow, "float", commandLine); \
 \
    msg.str("");msg << "";    TCLAP::ValueArg<float > modHighArg("", "modHigh", msg.str(), false, modHigh, "float", commandLine); \
 \
...
#define GENERATE_TCLAP_ASSIGNMENT \
      inputImageName = inputImageNameArg.getValue(); \
      outputDirectory = outputDirectoryArg.getValue(); \
      inputCSVName = inputCSVNameArg.getValue(); \
      aR = aRArg.getValue(); \
      aA = aAArg.getValue(); \
      bR = bRArg.getValue(); \
      bA = bAArg.getValue(); \
      slice = sliceArg.getValue(); \
      roiMult = roiMultArg.getValue(); \
      modLow = modLowArg.getValue(); \
      modHigh = modHighArg.getValue(); \
...
#define GENERATE_TCLAP_ASSIGNMENT_IFSET \
    if( inputImageNameArg.isSet() ) \
      { \
      inputImageName = inputImageNameArg.getValue(); \
      } \
    if( outputDirectoryArg.isSet() ) \
      { \
      outputDirectory = outputDirectoryArg.getValue(); \
      } \
    if( inputCSVNameArg.isSet() ) \
      { \
      inputCSVName = inputCSVNameArg.getValue(); \
      } \
    if( aRArg.isSet() ) \
...
std::cout << "    inputCSVName: " << inputCSVName << std::endl; \
...
std::cout << "    modLow: " << modLow << std::endl; \
std::cout << "    modHigh: " << modHigh << std::endl; \
